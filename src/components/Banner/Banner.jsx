          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Our Premium Blend Coffee is a rich, carefully curated combination of the finest coffee beans from around the world. Each cup delivers a smooth, full-bodied taste with subtle notes of chocolate and fruit. Experience the perfect harmony of boldness and refinement, crafted for those who appreciate the art of coffee.
                </p>
